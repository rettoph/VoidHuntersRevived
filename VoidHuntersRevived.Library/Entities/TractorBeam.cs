...
namespace GalacticFighters.Library.Entities
{
    ...
    public class TractorBeam : Entity
    {
        ...
        #region Constructors
        public TractorBeam(Ship ship, EntityCollection entities)
        {
            _selectionReach = 20;
            _atachmentReach = 1f;
            _entities = entities;
        ...
        protected override void Create(IServiceProvider provider)
        {
            ...
            this.Events.Register<ShipPart>("attached");
            this.Events.Register<Vector2>("offset:changed");
            this.Events.Register<Single>("rotation:changed");
        }
        #endregion
        ...
        public Boolean TrySelect(ShipPart target)
        {
            ...
            this.Events.TryInvoke(this, "selected", this.Selected);
            return true;
        }
        ...
        public Boolean TryRelease()
        {
            ...
            this.Events.TryInvoke(this, "released", oldTarget);
            return true;
        }
        ...
        public Boolean TryAttatch(FemaleConnectionNode target)
        {
            ...
            this.Events.TryInvoke(this, "attached", this.Selected);
        ...
        public void SetOffset(Vector2 offset)
        {
            if (offset != this.Offset)
            {
                ...
                this.Events.TryInvoke(this, "offset:changed", this.Offset);
            }
        }
        public void SetRotation(Single rotation)
        {
            if (this.Rotation != rotation)
            {
                ...
                this.Events.TryInvoke(this, "rotation:changed", this.Rotation);
            }
        }
