...
namespace GalacticFighters.Library.Entities
{
    ...
    public partial class Ship : NetworkEntity
    {
        ...
        protected override void Create(IServiceProvider provider)
        {
            ...
            this.Events.Register<Player>("player:changed");
            this.Events.Register<List<ShipPart>>("children:updated");
        }
        ...
        protected override void Initialize()
        {
            ...
            this.TractorBeam = this.entities.Create<TractorBeam>("entity:tractor-beam", t =>
            {
                t.Ship = this;
            });
        }
        ...
        public Boolean TrySetBridge(ShipPart target)
        {
            if (target != this.Bridge && target.IsRoot && !target.IsBridge && !target.Focused)
            {
                ...
                this.Events.TryInvoke(this, "bridge:changed", this.Bridge);
            }
        ...
        internal void SetPlayer(Player player)
        {
            ...
            this.Events.TryInvoke(this, "player:changed", this.Player);
        }
        #endregion
        ...
        /// <param name="e"></param>
        private void HandleBridgeDisposing(object sender, Creatable e)
        {
        ...
        protected void RemapBridge()
        {
            ...
            this.Events.TryInvoke(this, "children:updated", this.children);
        }
        #endregion
