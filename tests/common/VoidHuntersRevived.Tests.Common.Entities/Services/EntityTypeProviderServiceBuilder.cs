...
{
    public sealed class EntityTypeProviderServiceBuilder(EntityServiceBuilder? entityService = null) : BaseInstanceBuilder<EntityTemplateProviderService>
    {
        ...
        protected override EntityTemplateProviderService build()
        {
            return new EntityTemplateProviderService(
