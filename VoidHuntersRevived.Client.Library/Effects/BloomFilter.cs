...
namespace VoidHuntersRevived.Client.Library.Effects
{
    ...
    public class BloomFilter : IDisposable
    {
        ...
        public void Load(GraphicsDevice graphicsDevice, ContentLoader content, int width, int height, SurfaceFormat renderTargetFormat = SurfaceFormat.Color, QuadRenderer quadRenderer = null)
        {
            ...
            _bloomEffect = content.TryGet<Effect>("effect:bloom");
