...
{
    internal sealed partial class SimulatedService : ISimulatedService
    {
        private Dictionary<SimulatedId, SimulatedEntityMap> _ids;
        private Dictionary<SimulationType, Dictionary<int, SimulatedEntityMap>> _entityIds;

        public SimulatedService()
        {
            
            _ids = new Dictionary<SimulatedId, SimulatedEntityMap>();
            _entityIds = EnumHelper.ToDictionary<SimulationType, Dictionary<int, SimulatedEntityMap>>();
        }
