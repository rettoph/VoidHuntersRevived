...
namespace VoidHuntersRevived.Game.Server.Extensions
{
    ...
    {
        public static ContainerBuilder RegisterGameServerServices(this ContainerBuilder builder) => builder.EnsureRegisteredOnce(nameof(RegisterGameServerServices), builder =>
                                                                                                             {
