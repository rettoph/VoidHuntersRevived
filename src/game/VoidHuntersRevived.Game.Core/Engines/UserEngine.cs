...
namespace VoidHuntersRevived.Game.Core.Engines
{
        ...
        IEventEngine<UserJoined>
    {
        ...
        public void Process(VhId eventId, UserJoined data)
        {
            ...
            _treeService.Spawn(eventId, eventId.Create(1).ToGlobalEntityId(), _teamService.GetOpenTeam(), Resources.EntityTemplates.Ship.UserShipEntityTemplate, blueprint, (IEntityService entities, IEntityTemplate entityTemplate, EntityId id, ref EntityInitializer initializer) =>
            {
