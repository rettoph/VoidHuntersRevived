...
namespace VoidHuntersRevived.Game.Core.Engines
{
        ...
        IEventEngine<UserJoined>
    {
        ...
        public void Process(VhId eventId, UserJoined data)
        {
            ...
            _treeService.Spawn(eventId, eventId.Create(1), _teamService.GetOpenTeamComponent(), Resources.EntityTemplates.Ship.UserShipEntityTemplate, blueprint, (IEntityService entities, IEntityTemplate entityTemplate, EntityId id, ref EntityInitializer initializer) =>
            {
