...
namespace VoidHuntersRevived.Client.Library.Effects.Bloom
{
    /// <summary>
    /// https://github.com/Kosmonaut3d/BloomFilter-for-Monogame-and-XNA/blob/master/Bloom%20Sample/BloomFilter.cs
    /// 
    ...
    public class BloomFilter : IDisposable
    {
        ...
        public void Load(GraphicsDevice graphicsDevice, ContentService content, int width, int height, SurfaceFormat renderTargetFormat = SurfaceFormat.Color, QuadRenderer quadRenderer = null)
        {
            ...
            _bloomEffect = content.Get<Effect>("effect:bloom");
