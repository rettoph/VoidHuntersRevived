...
namespace VoidHuntersRevived.Client.Textures.Extensions.Farseer
{
    public static class VerticesExtensions
    {
        ...
        /// vertices with points all above 0, 0
        /// </summary>
        /// <returns></returns>
        ...
        {
            var image = new Bitmap((Int32)vertices.SelectMany(v => v).Max(v => Math.Round(v.X + pen.Width)) + 1, (Int32)vertices.SelectMany(v => v).Max(v => Math.Round(v.Y + pen.Width)) + 1);
